...
$requiredFields = "ad-first-name, ad-last-name, ad-street-address, ad-city, ad-zip-code, ad-state, ad-county, ad-phone-number,ad-email, cat-name, commitment, age-group-ad, allergies-ad, home, rent-or-own, ad-employed, number-pets-past, pet-surrender, indoor-outdoor, ad-livingconditions, ad-arrangements, vacation-stay, behavior-issues-one, behavior-issues-two, vet, willing-expenses, flea-preventative, home-visit, info-release, sign-application";

$defaultText = "Please submit your information below.";

$errorText = "TRY AGAIN! You didn't enter the required fields, silly!";

$successText = "YEAH! You submitted it and everything is super duper! We will get back to you within 3 business days.";
...
$multiFields = "ad-livingconditions, ad-arrangements";
