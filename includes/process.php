...
$requiredFields = "first-name, last-name, street-address, city, zip-code, state, county, phone-number,email, number-cats-female, number-cats-male, number-cats, government-assistance, agreements";
...
$multiFields = "government-assistance, number-cats-female, number-cats-male, number-cats, agreements";
