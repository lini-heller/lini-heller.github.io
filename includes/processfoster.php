...
$requiredFields = "fo-first-name, fo-last-name, fo-street-address, fo-city, fo-zip-code, fo-state, fo-county, fo-phone-number, fo-email, age-group-fo, rent-or-own-fo, fo-livingconditions, house-animals, foster-type, foster-time, night-place, day-place";
...
$multiFields = "fo-livingconditions, foster-type, foster-time";
